...
const AQMDashboard = () => {
    ...
    const fetchData = async () => {
      try {
        let data = await fetch(
          `https://api.addrupee.com/api/fetch_aqm_all_data_in_admin/${aqmEmailID}?filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
          {
            method: "GET",
            credentials: "include",
  ...
  const fetchPendingData = async () => {
    ...
    let data = await fetch(
      `https://api.addrupee.com/api/get_aqm_pending_data_in_admin/${aqmEmailID}?Status=${Status}&filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
      {
        method: "GET",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
  ...
  const fetchApprovedData = async () => {
    ...
    let data = await fetch(
      `https://api.addrupee.com/api/get_aqm_disbursed_data_in_admin/${aqmEmailID}?Status=${Status}&filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
      {
        method: "GET",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
  ...
  const fetchRejectedData = async () => {
    ...
    let data = await fetch(
      `https://api.addrupee.com/api/get_aqm_rejected_data_in_admin/${aqmEmailID}?Status=${Status}&filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
      {
        method: "GET",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
            ...
            <div className="row">
              ...
              <div className="col-12 col-md-6 col-lg-3 my-2 m-md-3 dashboard_card  dashboard_card-2">
                <Link
                  ...
                  href="/admindashboard/aqm/dashboard/pendingdata"
                >
                  <div className="card-inner">
              ...
              <div className="col-12 col-md-6 col-lg-3 my-2 m-md-3 dashboard_card  dashboard_card-3">
                <Link
                  style={{ textDecoration: "none" }}
                  href="/admindashboard/aqm/dashboard/disburseddata"
                >
                  <div className="card-inner">
              ...
              <div className="col-12 col-md-6 col-lg-3 my-2 m-md-3 dashboard_card  dashboard_card-4">
                <Link
                  style={{ textDecoration: "none" }}
                  href="/admindashboard/aqm/dashboard/rejecteddata"
                >
                  <div className="card-inner">
