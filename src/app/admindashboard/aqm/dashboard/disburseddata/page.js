  ...
  useEffect(() => {
    const fetchAlldata = async () => {
      ...
      let data = await fetch(
        `https://api.addrupee.com/api/get_aqm_disbursed_data_in_admin/${email}?Status=${Status}&filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
...
export default AQMDisbursedData;
