...
const CustomerForgotPasswordOTPVerification = () => {
  ...
  const handleOTPVerification = () => {
    axios
      .post(
        "https://api.addrupee.com/api/customer-forgot-password-otp-verification",
        { code: otp }
      )
      .then((response) => {
        if (
          ...
          router.push("/pages/customerresetpassword");
        } else {
      ...
      >
        ...
        >
          ...
          <Link
            ...
            className="btn"
            href={"/pages/customerforgotpassword"}
          >
            Go Back
          </Link>
        </div>
...
export default CustomerForgotPasswordOTPVerification;
