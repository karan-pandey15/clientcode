  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(
        "https://api.addrupee.com/api/customer-forgot_password",
        { email }
      );
      ...
      if (response.data.status === "Success") {
        ...
        router.push("/pages/customerforgotpasswordotpverification");
      } else {
...
export default CustomerForgotPasword;
