  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(
        "https://api.addrupee.com/api/forgot_password",
        { email }
      );
      ...
      if (response.data.status === "Success") {
        ...
        router.push("/pages/employeeforgotpasswordotpverification");
      } else {
...
export default EmployeeForgotPasword;
