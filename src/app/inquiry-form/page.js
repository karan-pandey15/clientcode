...
const Contact = () => {
  ...
  const [showCibileError, setShowCibileError] = useState(false);
  ...
  const handleSubmit = (event) => {
    ...
    const minimumCibil = 700;
    if (parseInt(formData.cibilScore, 10) < minimumCibil) {
      setShowCibileError(true);
      return;
    } else {
      setShowCibileError(false);
    }
          ...
          >
            ...
            <div className="col-12 col-lg-6 col-md-6 py-3 contact_form-shadow">
              ...
              >
                ...
                <div className="form-group py-2">
                  <label htmlFor="mobileNo">Your Mobile No</label>
                  <input
                    type="text"
                    className="form-control"
                    id="mobileNo"
                ...
                <div className="form-group py-2">
                  <label htmlFor="cibilScore">Enter Your CIBIL</label>
                  <input
                    type="text"
                    className="form-control"
                    id="cibilScore"
                    ...
                    pattern="[0-9]*"
                    maxLength="3"
                    title="Please enter a valid CIBIL score"
                    placeholder="Minimum 700 CIBIL required"
                  />
                  {showCibileError && (
                ...
                <div className="form-group py-2">
                  <label htmlFor="employmentType">Your Employment Type</label>
                  <select
                    className="form-select"
                    id="employmentType"
                    name="employmentType"
                ...
                <div className="container mt-5">
                  <div className="row">
                    <h6 style={{ fontWeight: 700, color: "#264653" }}>
                      Choose Product
                    </h6>
                    {(showMoreOptions
