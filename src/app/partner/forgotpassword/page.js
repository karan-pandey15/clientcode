...
const PartnerEmployeeForgotPasword = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(
        "https://api.addrupee.com/api/partner_employee_forgot_password",
        { email }
      );
      ...
      if (response.data.status === "Success") {
        ...
        router.push("/partner/forgotpasswordotpverification");
      } else {
...
export default PartnerEmployeeForgotPasword;
