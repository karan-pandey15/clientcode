...
const PartnerEmployeeForgotPasswordOTPVerification = () => {
  ...
  const handleOTPVerification = () => {
    axios
      .post(
        "https://api.addrupee.com/api/partner_employee-forgot-password-otp-verification",
        { code: otp }
      )
      .then((response) => {
        if (
...
export default PartnerEmployeeForgotPasswordOTPVerification;
