        ...
        >
          ...
          <div className="container" style={{ padding: "20px" }}>
            ...
            <form onSubmit={HandleSubmit}>
              <div className="row">
                ...
                <div className="mb-3 col-12 col-lg-6 col-md-6">
                  <label htmlFor="appliedBank" className="form-label">
                    Which Banks Do You Want To Apply To:
                  </label>
                  <select
                    className="form-select"
                    name="Bank_Name"
              ...
              {formData.Product_Loan === "Business Loan-BL" ? (
                <div className="row">
                  <div className="mb-3 col-12 col-lg-4 col-md-6">
                    <label htmlFor="Customer_Profile" className="form-label">
                      Customer Profile:
                    </label>
                    <select
                      className="form-select"
                  ...
                  <div className="mb-3 col-12 col-lg-4 col-md-6">
                    <label htmlFor="Company_Vintage" className="form-label">
                      Company Vintage:
                    </label>
                    <input
                      type="text"
                      className="form-control"
                      name="Company_Vintage"
                      value={formData.Company_Vintage}
                      onChange={handleChange}
                      required
                    />
                  </div>
              ...
              {formData.Product_Loan === "Business Loan-BL" ? (
                <div className="row">
                  <div className="mb-3 col-12 col-lg-4 col-md-6">
                    <label
                      htmlFor="Current_Account_BankName"
                      className="form-label"
                    >
                    ...
                    <input
                      type="text"
                      className="form-control"
                      name="Current_Account_BankName"
                      value={formData.Current_Account_BankName}
                      onChange={handleChange}
                      required
                    />
                  </div>
                  <div className="mb-3 col-12 col-lg-4 col-md-6">
                    <label htmlFor="Annual_Tenure" className="form-label">
                      Annual Tenure:
                    </label>
                    <input
                      type="text"
